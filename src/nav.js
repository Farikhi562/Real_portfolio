export const NAV = [
  { path: '/', file: 'home.jsx', label: 'Home', folder: 'root' },
  { path: '/about', file: 'about.jsx', label: 'The Model', folder: 'root' },
  { path: '/architecture', file: 'architecture.jsx', label: 'Architecture', folder: 'root' },
  ...
  { path: '/nexa-campus', file: 'nexa-campus.jsx', label: 'NEXA Campus Case Study', folder: 'company' },
